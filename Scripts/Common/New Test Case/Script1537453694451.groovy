...
WebUI.setText(findTestObject('Page_Login - My Store/input_Email address_email'), user)
...
WebUI.verifyElementPresent(findTestObject('Page_Login - My Store/span_Sign in'), 0)
